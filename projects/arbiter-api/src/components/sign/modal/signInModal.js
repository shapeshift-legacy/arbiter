...
import {signIN, switchSingINModal, switchSingUPModal, switchResetPasswordModal} from '../../../actions/index'
...
class SingUpModal extends Component {
    ...
    render() {
        ...
        const {
            push, switchSingINModal, signin, switchSingUPModal, switchResetPasswordModal, signIN
        } = this.props;
