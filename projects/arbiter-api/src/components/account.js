...
class Account extends Component{
    ...
    componentDidMount() {
        ...
        let fox_user = cookie.get('fox_user')
                            ...
                            <Col className='col-3 left-nav'>
                                <ListGroup className='it-pointer'>
                                    <ListGroupItem>
                                        <Row>
                                            <Col className='col-3'>
                                                <img src={account.icon} className='rounded-circle'/>
                                            </Col>
                                            <Col className='col-9 text-left name'>
                                                <strong className='it-fs18 pl-2'>{account.email}</strong>
                                                <p className='it-fs12 it_light_opacity pl-2'>{account.logins[2]}</p>
                                            </Col>
                                        </Row>
                                    </ListGroupItem>
                                                    ...
                                                    <div className='session'>
                                                        ...
                                                        <Table className='table-night'>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>1.2.3.4 <span className='it-half-opacity'>Saint Petersburg, Russia</span></td>
                                                                <td>05:36</td>
                                                                <td>09-06-2017</td>
