...
describe.skip('Arbiter End 2 End Test case 7b LTC (unfulfilled + arbiter fail +  cancel request to oracle)', function ()
{
    ...
    it('Customer signs TX', async function (){
        ...
        this.timeout(1000 * 60 * 6);
        //for loop polling?
        let signedTx = await ltc.signRawTransaction(returnTx)
    ...
    it('Oracle broadcasts TX', async function (){
        ...
        let broadcast = await arbiter.broadCastOracle("LTC",completeTx)
